...
public class Runner {
    public static void main(String[] args) {
        ...
        Pillow cottonpillow = new Cotton();
        cottonpillow.square();
        System.out.println();
        ...
        Computer monitorComputer = new Monitor();
        monitorComputer.mouse();
        System.out.println();
        ...
        Electronic phoneElectronic = new Phone();
        phoneElectronic.device();
        System.out.println();
        ...
        Nail nail = new Nail();
        Nail polishedNail = new NailPolish();
        polishedNail.paint();
        System.out.println();
